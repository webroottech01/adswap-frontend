...
interface Step6BrandProofProps {
  form: UseFormReturn<BusinessFormData>;
}

/**
 * Step 6: Brand Proof Upload
 */
export function Step6BrandProof({ form }: Step6BrandProofProps) {
  ...
  return (
    <div className="card">
      <div className="card-header">
        <h5 className="mb-0">Brand Proof Upload</h5>
      </div>
      <div className="card-body">
        <div className="mb-4">
          <label htmlFor="brandProofs" className="form-label">
            Upload Brand Proof Images or Documents
          </label>
          <input
            id="brandProofs"
            type="file"
